...
6. Paste the url:  https://kvdb.io/DL6nxEC6kLcLeM2NyrKgoy/XXXXXXXXXX replace XXXXXXXXXX with your phone number
7. Method is PUT
...
**Now Enter URL : https://kvdb.io/DL6nxEC6kLcLeM2NyrKgoy/XXXXXXXXXX & replace XXXXXXXXXX with your mobile number**

*Copy from below*
```
https://kvdb.io/DL6nxEC6kLcLeM2NyrKgoy/
```
...
6.     Then add another action and select `URL` and paste the url: https://kvdb.io/DL6nxEC6kLcLeM2NyrKgoy/XXXXXXXXXX replace XXXXXXXXXX with your phone number
